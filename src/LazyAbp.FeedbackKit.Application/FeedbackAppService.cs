using System;
using LazyAbp.FeedbackKit.Permissions;
...
namespace LazyAbp.FeedbackKit
{
    public class FeedbackAppService : ApplicationService, IFeedbackAppService
    {
        ...
        [Authorize(FeedbackKitPermissions.Feedback.Default)]
        public async Task<PagedResultDto<FeedbackDto>> GetListAsync(GetFeedbackListRequestDto input)
        {
        ...
        public async Task<PagedResultDto<FeedbackDto>> GetManagementListAsync(GetFeedbackListRequestDto input)
        {
        ...
        public async Task<FeedbackDto> CreateAsync(CreateUpdateFeedbackDto input)
        {
